...
execute at @e[type=minecraft:armor_stand,name=totem2] run setblock ~-64 ~ ~ minecraft:fire
execute at @e[type=minecraft:armor_stand,name=totem2] run setblock ~-64 ~1 ~ minecraft:fire
execute at @e[type=minecraft:armor_stand,name=totem2] run setblock ~-64 ~2 ~ minecraft:fire
