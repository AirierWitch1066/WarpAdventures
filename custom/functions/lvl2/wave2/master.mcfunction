...
schedule function custom:lvl2/wave2/minions 200t append
schedule function custom:lvl2/wave2/minions 600t append
schedule function custom:lvl2/wave2/boss 800t append