...
execute if score global timer = 0 math run execute if score global timeswarped < global numberofplayers run say "Someone didn't make it through the portal. No levels completed. Game Over. Please reset"
...
execute if score global timeswarped = global numberofplayers run schedule function custom:lvl2/master 20t append
