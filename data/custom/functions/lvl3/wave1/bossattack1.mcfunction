...
execute at @e[type=minecraft:giant] run summon minecraft:bat ~ ~ ~ {Glowing: 1b, CustomNameVisible: 1b, Passengers: [{id: "minecraft:creeper", CustomNameVisible: 1b, Fuse: 1, ignited: 0b, ActiveEffects: [{Id: 14b, Amplifier: 1b, Duration: 10000, ShowParticles: 0b}], Attributes: [{Name: "generic.attack_damage", Base: 6}]}], CustomName: '{"text":"Explosive Bat","color":"red","bold":true,"italic":true,"underlined":true}'}
